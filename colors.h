...
static const char *colors[][3]      = {
	/*                   fg             bg                   border   */
	[SchemeState0]   = { black,         red,                 red  },
	[SchemeState1]   = { black,         aerospace_orange,    aerospace_orange  },
	[SchemeState2]   = { black,         orange_peel,         orange_peel  },
	[SchemeState3]   = { black,         jonquil,             jonquil  },
	[SchemeState4]   = { black,         yellow,              yellow  },
	[SchemeState5]   = { black,         lime,                lime  },
	[SchemeState6]   = { black,         bright_green,        bright_green  },
	[SchemeState7]   = { black,         green,               green  },
	[SchemeState8]   = { black,         lime_green,          lime_green  },
	[SchemeState9]   = { white,         forest_green,        forest_green },

	[SchemePrimary0] = { black,         alice_blue,          alice_blue  },
	[SchemePrimary1] = { black,         uranian_blue,        uranian_blue  },
	[SchemePrimary2] = { black,         light_sky_blue,      light_sky_blue  },
	[SchemePrimary3] = { black,         argentinian_blue,    argentinian_blue  },
	[SchemePrimary4] = { black,         bleu_de_france,      bleu_de_france  },
	[SchemePrimary5] = { black,         french_blue,         french_blue  },
	[SchemePrimary6] = { white,         green_blue,          green_blue  },
	[SchemePrimary7] = { white,         cobalt_blue,         cobalt_blue  },
	[SchemePrimary8] = { white,         oxford_blue,         oxford_blue  },
	[SchemePrimary9] = { white,         prussian_blue,       prussian_blue  },
